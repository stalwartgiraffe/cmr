...
type MergeRequest struct {
	...
	Milestone                   omitnull.Val[string] `json:"milestone"`
	MergeWhenPipelineSucceeds   bool                 `json:"merge_when_pipeline_succeeds"`
	MergeStatus                 string               `json:"merge_status"`
	DetailedMergeStatus         string               `json:"detailed_merge_status"`
	SHA                         string               `json:"sha"`
	MergeCommitSHA              omitnull.Val[string] `json:"merge_commit_sha"`
	SquashCommitSHA             omitnull.Val[string] `json:"squash_commit_sha"`
	DiscussionLocked            omitnull.Val[bool]   `json:"discussion_locked"`
	ShouldRemoveSourceBranch    omitnull.Val[bool]   `json:"should_remove_source_branch"`
...
type UserBasic struct {
	...
	State     string               `json:"state"`
	AvatarURL omitnull.Val[string] `json:"avatar_url"`
	WebURL    string               `json:"web_url"`
}
...
type TimeStats struct {
	...
	HumanTimeEstimate   omitnull.Val[string] `json:"human_time_estimate"`
	HumanTotalTimeSpent omitnull.Val[string] `json:"human_total_time_spent"`
}
