...
// MergeRequestV0 represents a GitLab merge request as per API_Entities_MergeRequestBasic
type MergeRequestV0 struct {
	...
	MergedBy                    *UserBasicV0  `json:"merged_by,omitempty"`
	MergeUser                   *UserBasicV0  `json:"merge_user,omitempty"`
	MergedAt                    time.Time     `json:"merged_at" fake:"{date}"`
	ClosedBy                    *UserBasicV0  `json:"closed_by,omitempty"`
	...
	Author                      *UserBasicV0  `json:"author,omitempty"`
	Assignees                   []UserBasicV0 `json:"assignees,omitempty" fakesize:"0,3" `
	Assignee                    *UserBasicV0  `json:"assignee,omitempty"`
	Reviewers                   []UserBasicV0 `json:"reviewers,omitempty fakesize:"0,3" `
...
// MergeRequestsQueryParamsV0 represents the query parameters for the merge requests endpoint
type MergeRequestsQueryParamsV0 struct {
	PageQueryParams
